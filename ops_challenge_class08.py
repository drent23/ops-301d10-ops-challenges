...
# Clear
# grocery_list.clear()
# print("If I take everything off the list, it looks like this: ", grocery_list)

# Copy
# second_list = grocery_list.copy()
# print("Here's a copy of the list: ", second_list)
...
# print("I need to make sure I don't forget my wife's favorite fruit so I'll put the following as the first thing on my list: ", grocery_list)
